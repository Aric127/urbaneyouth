            ...
            <div class="col-sm-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="adv-table editable-table event-list-table"> 
							<div class="row">
                           ...
                           <table class="table table-striped table-hover table-bordered table-small-font" 
                           id="editable-sample">
                                <thead>
                                <tr>
                                    <th>S.no</th>
                 ...
                 if (!empty($event_list)) {
                    ...
                    foreach ($event_list as $value) { ?>
                                <tr class="">
                                   ...
                                   <td><?php echo $value->event_contact_no ; ?> </td>
                                   <td><?php echo $value->event_desc ; ?> </td>
                                   <td> <img src="<?php echo event_image."/".$value->event_image; ?>" height="90" width="90"> </td>
