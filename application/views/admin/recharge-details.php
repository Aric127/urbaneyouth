       ...
       <input type="hidden" id="recharge_amt_with_wallet" value="<?php echo $payble_amount; ?>" />
        ...
        <div class="cpoupons">
        	<div class=""  id="free_oupons">
                ...
                <a href="#" class="label label-warning form-group voucher pull-left">Get Offer</a>
                <div class="clearfix"></div>
                <div class="offer_img">
                	<div class="del_img"><i class="fa fa-close"></i></div>
                	<img class="" width="50" height="40"  src="http://i.dailymail.co.uk/i/pix/2016/03/22/13/32738A6E00000578-3504412-image-a-6_1458654517341.jpg" alt="..."/>
                </div>
                <div class="offer_img">
                	<div class="del_img"><i class="fa fa-close"></i></div>
                	<img class="" width="50" height="40" src="http://i.dailymail.co.uk/i/pix/2016/03/22/13/32738A6E00000578-3504412-image-a-6_1458654517341.jpg" alt="..."/>
