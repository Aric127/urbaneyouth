          ...
          <div class="col-md-8 col-12 mr-auto ml-auto">
            ...
            <div class="wizard-container">
              <div class="card card-wizard" data-color="rose" id="wizardProfile">
                <form action="<?php echo base_url('event/update_biller_info'); ?>" method="post" name="biller_profile" enctype="multipart/form-data">
                          ...
                          <div class="col-sm-3">
                            <div class="picture-container">
                              <div class="picture">
                                ...
                                <input type="file" id="wizard-picture" name="biller_company_logo" >
                              </div>
                         ...
                         <div class="row justify-content-center">
                          ...
                          <div class="col-sm-9">
                            ...
                            <div class="form-group select-wizard">
                             <?php if($biller_details[0]->biller_status==1 && !empty($biller_details[0]->bank_name)){?>
                          ...
                          <?php   } ?>
                            ...
                            <div class="form-group">
                              ...
                              <input  <?php if($biller_details[0]->biller_status==1 && !empty($biller_details[0]->bank_name)){?> readonly="readonly" <?php } ?> type="text" class="form-control" name="bank_account_no" id="bank_account_no"  required="" value="<?php if(!empty($biller_details)){
