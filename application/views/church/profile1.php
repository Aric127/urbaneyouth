          ...
          <div class="col-md-8 col-12 mr-auto ml-auto">
            ...
            <div class="wizard-container">
              <div class="card card-wizard" data-color="rose" id="wizardProfile">
                <form action="<?php echo base_url('church/update_biller_info'); ?>" method="post" name="biller_profile" enctype="multipart/form-data">
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane" id="account">
                       ...
                       <!--    
                            ...
                            <div class="form-group">
                          <div class="dropdown bootstrap-select" style="width: 100%!important;"><select class="selectpicker" data-size="7" data-style="btn btn-primary btn-round" title="Single Select" tabindex="-98"><option class="bs-title-option" value=""></option>
                            <option disabled="" selected="">Biller Category</option>
