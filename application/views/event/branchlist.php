                    ...
                    foreach ($branch_list as $value) { ?>
                        ...
                        <tr>
                           ...
                           <td style="width: 15%"><img src="<?php echo church_image.'/'.$value->church_area_img; ?>" height="90" width="90"></td>
                            ...
                            <td style="width: 40%" class="action">
                           <!--  <a href="<?php echo site_url('church/edit_church') . '/' . $value->church_area_id; ?>" class="btn btn-blue btn-sm btn-icon icon-lef" >Edit</a>  -->
                                ...
                                <?php if ($status == 1) { ?>
                                <a href="<?php echo site_url('church/change_status') . '/church_area_id/' . $value->church_area_id; ?>/church_area/church_area_status/2/church_list" class="btn btn-secondary btn-sm btn-icon icon-left"><i class="material-icons">check</i></a>
                                <?php } elseif ($status == 2) { ?>
                                <a href="<?php echo site_url('church/change_status') . '/church_area_id/' . $value->church_area_id; ?>/church_area/church_area_status/1/church_list" class="btn btn-warning btn-sm btn-icon icon-left"><i class="material-icons">check</i></a>
                                <?php } ?> 
