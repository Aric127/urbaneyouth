            ...
            <div class="col-sm-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="adv-table editable-table slide-content-table">
                            <div class="clearfix">
                                <!--<div class="btn-group">
                    ...
                    foreach ($main_content as $value) {
                        ?>
                                <tr class="">
                                    ...
                                    <td><a href="<?php echo site_url('admin/edit_main_content') . '/' . $value->main_content_id; ?>" class="btn btn-info btn-xs">Edit</a></td>
                                </tr>
								 <?php $n = $n + 1;
    }
} ?>
