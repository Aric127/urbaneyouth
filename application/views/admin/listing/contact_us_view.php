                ...
                if (!empty($contact_us)) {
                    ...
                    foreach ($contact_us as $value) {
                        ...
                        <tr>
                            ...
                            <td style="width: 25%"><?php echo $value->contact_name; ?></td>
                            <td style="width: 15%"><?php echo $value->contact_email; ?></td>
                            <td style="width: 5%"><?php echo $value->contact_number; ?></td>
                            <td><?php echo $value->conatct_website; ?></td>
                            <td style="width: 5%">

        <?php $status = $value->contact_us_status; ?>

                                <a href="<?php echo site_url('admin/edit_contact_us') . '/' . $value->contact_us_id; ?>" class="" ><i class="fa-pencil icon-blue"></i>
                                    &nbsp;
                                    <!-- <?php if ($status == 1) { ?>
