...
<div class="table-responsive">
    ...
    //   print_r($wallet_transaction);
                    ...
                    foreach ($wallet_transaction as $value) {
                     	$trans_type=$value->trans_pay_type;

						if($trans_type=='1'){
							$trans_type=" From card";
						}else if($trans_type=='2'){
								$trans_type="From net banking";
						}else if($trans_type=='3'){
								$trans_type="Wallet to Bank";
						}
                        ...
                        <tr>
                            ...
                            <td  style="width: 10%"><?php 
                                echo $trans_type;
                            //echo $trans_pay_type ?></td>
                        	 <td style="width: 20%"><?php echo $value->p_transaction_id." / ".$value->p_reffernce_id;?></td>
                            <td><?php echo $value->pay_trans_amount; ?></td>
                            <td style="width: 15%"><?php echo $value->p_trans_datetime;?></td>
                            <td style="width: 10%"> <?php {echo $value->pay_trans_status; }?></td>
