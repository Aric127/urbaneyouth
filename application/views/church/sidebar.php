<script src="https://use.fontawesome.com/527280541e.js"></script>
 ...
 <div class="sidebar" data-color="rose" data-background-color="black" data-image="<?php echo base_url('biller_assets/img/sidebar-1.jpg');?>">
     <div class="logo">
        <a href="<?php echo base_url('church'); ?>" class="simple-text logo-mini">
      ...
      <div class="sidebar-wrapper">
       <?php $segment = $this->uri->segment(2); ?>
        <ul class="nav">
          <li <?php if(($this->uri->segment(1) == 'church') && ($this->uri->segment(2) == '' || $this->uri->segment(2) == 'index')){ ?> class="active"
                            <?php } ?> class="nav-item ">
            <a class="nav-link" href="<?php echo base_url('church') ?>">
              <i class="material-icons">dashboard</i>
              <p> Dashboard </p>
            </a>
          </li>
          <li <?php if(($this->uri->segment(2) == 'church_profile')){ ?> class="active"
                            <?php } ?> class="nav-item ">
            <a class="nav-link" href="<?php echo base_url('church/church_profile') ?>">
         ...
         <?php if($biller_details[0]->biller_status==1){ ?>
          <li class="nav-item ">
            <a class="nav-link" href="<?php echo base_url('church/church_product_list'); ?>">
              
               <i class="material-icons">games</i>
              <p> Products</p>
            </a>
               <div <?php if($this->uri->segment(2) == 'church_product_list'){ ?> class="collapse show"
          ...
          <li  class="nav-item ">
            <a class="nav-link" href="<?php echo base_url('church/branch_list'); ?>">
              <i class="material-icons">description</i>
              <p> Branches
               
              </p>
            </a>
                <div  <?php if($this->uri->segment(2) == 'branch_list'){ ?> class="collapse show"
                                            <?php } ?> class="collapse" id="componentsExamples">
              <ul class="nav">
                <li <?php if($this->uri->segment(2) == 'branch_list'){ ?> class="opened active"
                                            <?php } ?> class="nav-item ">
                  <a class="nav-link" href="">
                    <i class="fa fa-file-text-o" aria-hidden="true" style="font-size: 13px;"></i>

                    <span class="sidebar-normal"> Branch list
          ...
          <li <?php if($this->uri->segment(2) == 'donation_list'){ ?> class="opened active"
                                            <?php } ?>  class="nav-item ">
            <a class="nav-link" href="<?php echo site_url('church/donation_list'); ?>">
          ...
          <div <?php if($this->uri->segment(2) == 'my_bill_sattlement'){ ?> class="collapse show"
                                            <?php } ?> class="collapse" id="tablesExamples">
              <ul class="nav">
                <li <?php if($this->uri->segment(2) == 'my_bill_sattlement'){ ?> class="opened active"
                                            <?php } ?> class="nav-item ">
                  <a class="nav-link" href="<?php echo base_url('church/my_bill_sattlement') ?>">
        ...
        <li <?php if($this->uri->segment(2) == 'configuiration'){ ?> class="opened active" <?php } ?> class="nav-item ">
            <a class="nav-link" href="<?php echo site_url('church/configuiration'); ?>">
                ...
                <li class="nav-item ">
                  <a class="nav-link" href="javascript:void(0);">
                   <i class="fa fa-exchange" aria-hidden="true" style="font-size: 13px;"></i>
                    ...
                    <span class="sidebar-normal"> Donation user</span>
                  </a>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink" id="pwd">
                  ...
                  <a class="dropdown-item" href="<?php echo base_url('church/logout'); ?>"> <i class="material-icons">arrow_upward</i> Logout</a>
