...
<div style="width: 649px;margin: 10px auto;border: #ececec solid 1px;background: #fff;margin-bottom: 100px;padding-bottom: 30px;padding-top: 10px;" id="current_page">
  <div style="margin: 22px 34px 0px 34px;border: 1px solid #ccc;border-bottom: 0;width: 90.3%;position: relative;left: -2px;">
    ...
    <div class="detail-page" style="color:#333333;font:normal 14px Arial,Helvetica,sans-serif;width:100%;padding-left: 30px;">
      ...
      <!-- <div style="padding-top:10px;" >123456789 <br>abcd4@gmail.com</a>
      </div> -->
    </div>
    <!-- <div style="float:right;width:300px;margin-top:41px">
      <div style="float:left;font:normal 12px Arial,Helvetica,sans-serif;color:#999999;width:210px;text-align:right;margin-top:10px;margin-left:6px">
        <br> We are here 24 X 7 for you! Please</div>
    </div> -->
    <div style="clear:both"></div>
  </div>
  <div style="width:584px;background-color:#ffffff;border:#e8e7e7 solid 1px;padding: 7px 0 0px;margin:0 auto;border-bottom:0">
    <div style="border-bottom:#ccc solid 1px;font:normal 14px Arial,Helvetica,sans-serif;color:#666666;padding:0px 33px 10px">
      <br>
    ...
    <div style="border-bottom:#ccc solid 1px;font:normal 14px Arial,Helvetica,sans-serif;color:#666666;padding:10px 33px 10px">
      <br>
      <table style="width:100%" cellspacing="0" cellpadding="2" border="0">
        <tbody>
        <tr>
    ...
    <div style="border-bottom:#ccc solid 1px;font:600 14px Arial,Helvetica,sans-serif;color:#333333;padding:17px 33px 17px">
      <table style="width:100%" cellspacing="0" cellpadding="2" border="0">
        <tbody>
        <tr>
    ...
    <form style="margin:0;font:normal 12px Arial,Helvetica,sans-serif" id="m_407477710045046901m_-4127472163058342348m_-5297201480658981960surveyForm" target="_blank">
      <table style="padding:15px" width="100%" cellspacing="0" cellpadding="0">
        <tbody>
        <tr>
          <!-- <td style="padding:10px 0px 10px 10px;font-size:12px" valign="top" align="left"><p style="margin:0px 0px 10px 0px;font-size:13px"><span style="font-size:13px">How likely is it that you would recommend Oyacharge to a friend or a colleague?
          </span></p>        <br>  
