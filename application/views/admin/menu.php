...
<head>
	...
	<link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Arimo:400,700,400italic">
        ...
        <link href="http://cdnjs.cloudflare.com/ajax/libs/simple-line-icons/2.4.1/css/simple-line-icons.css" rel="stylesheet">
...
<body class="page-body">
   ...
   <li <?php if($this->uri->segment(2) == 'User-List' || $this->uri->segment(2) == 'User-List'|| $this->uri->segment(2) == 'User-Transaction'|| $this->uri->segment(2) == 'View-Transaction'){ ?>class="opened active"<?php } ?>>
        <a href="<?php echo site_url('User-List'); ?>">
            <i class="icon-user"></i>
            <span class="title">User  <span id="user_count" class="push-notification-bg">0</span></span>
        </a>
       <!--
        <ul>
                   <li <?php if($this->uri->segment(2) == 'User-List'){ ?>class="active"<?php } ?>>
                       <a href="<?php echo site_url('User-List'); ?>">
     ...
     <li <?php if($this->uri->segment(2) == 'GuestUser'){ ?> class=" active"<?php } ?>>
        <a href="<?php echo site_url('GuestUser'); ?>">
            <i class="icon-user"></i>
            <span class="title">Guest User </span>
        </a>
    </li>
<li <?php if($this->uri->segment(1) == 'Agents'|| $this->uri->segment(2) == 'view_agent_list'){ ?> class="active" <?php } ?>>
     ...
     <li <?php if($this->uri->segment(2) == 'biller_category' || $this->uri->segment(2) == 'add_biller_category'|| $this->uri->segment(2) == 'edit_biller_category'){ ?>class="opened active"<?php } ?>>
       ...
       <li <?php if($this->uri->segment(2) == 'biller_list' ||$this->uri->segment(2) == 'view_biller_details' || $this->uri->segment(2) == 'add_biller'|| $this->uri->segment(2) == 'edit_biller' ||$this->uri->segment(2) == 'bill_status'){ ?> class="opened active"<?php } ?>>
        ...
        <ul>
          ...
          <ul>
            <li <?php if($this->uri->segment(2) == 'sattlement'){ ?>class="active"<?php } ?>>
                <a href="<?php echo site_url('admin/sattlement'); ?>">
                    <span class="title">Bill Sattlement</span>
                </a>
            </li>
         </ul>
    </li>
    <li <?php if($this->uri->segment(2) == 'donation_list' || $this->uri->segment(2) == 'church_list'){ ?>class="opened active"<?php } ?>>
        ...
        <li <?php if($this->uri->segment(2) == 'event_list'||$this->uri->segment(2) == 'event_viewer' ||$this->uri->segment(2) == 'event_viewer_details' || $this->uri->segment(2) == 'add_eventer'|| $this->uri->segment(2) == 'edit_eventer' ||$this->uri->segment(2) == 'bill_status'){ ?>class="opened active"<?php } ?>>
        ...
        <ul>
          ...
          <ul>
            <li <?php if($this->uri->segment(2) == 'EventList'){ ?>class="active"<?php } ?>>
                <a href="<?php echo site_url('EventList'); ?>">
                    <span class="title">Event List</span>
                </a>
            </li>
         </ul>
          <ul>
            <li <?php if($this->uri->segment(2) == 'Event-Transaction'){ ?>class="active"<?php } ?>>
                <a href="<?php echo site_url('Event-Transaction'); ?>">
                    <span class="title">Event Transaction <span id="event_trans_count" class="push-notification-bg">0</span></span>
                </a>
            </li>
         </ul>
    </li>
     ...
     <!--    <ul>
        ...
        <ul>
            <li <?php if($this->uri->segment(2) == 'dstv_plan' || $this->uri->segment(2) == 'add_dstv_plan'|| $this->uri->segment(2) == 'edit_dstv_plan'){ ?>class="active"<?php } ?>>
                <a href="<?php echo site_url('admin/dstv_plan'); ?>">
                    <span class="title">DSTV Plan</span>
                </a>
            </li>
 ...
 <li <?php if($this->uri->segment(2) == 'transaction_list' || $this->uri->segment(2) == 'view_perticuler_transaction'|| $this->uri->segment(2) == 'wallet_bank_trans' ){ ?>class="opened active"<?php } ?>>
        <a href="<?php echo site_url('admin/transaction_list'); ?>">
            <i class="fa fa-exchange"></i>
            <span class="title">Transactions <span id="trans_count" class="push-notification-bg">0</span></span>
        </a>
        <ul>
           ...
           <!--   <li <?php if($this->uri->segment(2) == 'transaction_list_fail'){ ?>class="active"<?php } ?>>
                <a href="<?php echo site_url('admin/transaction_list_fail'); ?>">
                    <span class="title">Transactions List(Failed)</span>
                </a>
            </li> -->
        </ul>
         <ul>
            <li <?php if($this->uri->segment(2) == 'wallet_bank_trans'){ ?>class="active"<?php } ?>>
                <a href="<?php echo site_url('admin/wallet_bank_trans'); ?>">
                    <span class="title">Wallet To Bank</span>
                </a>
            </li>
        </ul>
 ...
 <li <?php if($this->uri->segment(2) == 'Track'  ){ ?>class="opened active"<?php } ?>>
       ...
       <li <?php if($this->uri->segment(2) == 'about_us' || $this->uri->segment(2) == 'add_about_content'){ ?>class="opened active"<?php } ?>>
        ...
        <ul>
            ...
            <li <?php if($this->uri->segment(2) == 'faq' || $this->uri->segment(2) == 'edit_faq'){ ?>class="active"<?php } ?>>
...
<script>
	  var refreshId = setInterval(function(){
    	$.ajax({
		url : "<?php echo site_url('admin/counter'); ?>",
		...
		success : function(data) {
			var getdata = jQuery.parseJSON(data);
				var user = getdata.user_count;
				var trans= getdata.trans;
				var event_trans= getdata.event_trans;
				$("#user_count").html(user);
				$("#trans_count").html(trans);
				$("#event_trans_count").html(event_trans);
		}
	});
