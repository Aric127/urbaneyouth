...
<?php } ?>
        <div class="row">
            <div class="col-sm-12">
                <section class="panel">
                    <header class="panel-heading"> Recharge content
                        ...
                        ?>
                            ...
                            <td><?php echo $value->tv_recharge; ?></td>
                             ...
                             <td><?php echo $value->share_app_content; ?></td>
                                    <td><a href="<?php echo site_url('admin/edit_recharge_content') . '/' . $value->recharge_content_id; ?>"class="btn btn-info btn-xs"> Edit </a></td>
                                </tr>
								<?php $n = $n + 1;
    }
} ?>
